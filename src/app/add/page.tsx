          ...
          <div className="bg-white shadow-md p-8 rounded-lg flex flex-col gap-8 max-w-6xl mx-auto text-black">
              ...
              <div className="flex flex-col gap-5">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 w-full border border-gray-300 rounded-md px-4 py-2 text-black focus:outline-none focus:ring-2 focus:ring-black"
                  />
                </div>
                <div>
                ...
                <div>
                  <label className="text-sm font-semibold">
                    Descrição <span className="text-xs text-gray-400">(máx. 500 caracteres)</span>
                  </label>
                  <textarea
                    rows={4}
                    value={description}
                    ...
                    className="mt-1 w-full border border-gray-300 rounded-md px-4 py-2 text-black focus:outline-none focus:ring-2 focus:ring-black resize-none"
                  />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              <div className="flex flex-col">
                ...
                <select className="w-full border border-gray-300 rounded-md px-4 py-2 text-black focus:outline-none focus:ring-2 focus:ring-black">
                  {languages.map((lang) => (
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-md px-4 py-2 text-black focus:outline-none focus:ring-2 focus:ring-black"
                />
                <div className="mt-2 flex flex-wrap gap-2">
                  {tags.map((tag, index) => (
                    <div key={index} className="flex items-center bg-gray-200 text-black px-3 py-1 rounded-full text-sm">
                      <span>{tag}</span>
                      <button onClick={() => handleRemoveTag(index)} className="ml-2 text-gray-600 hover:text-red-600 font-bold">
                        ×
                      </button>
                    </div>
                  ))}
            ...
            <div className="border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100 transition-colors rounded-lg p-6 text-center">
              {!bookFile ? (
                <>
                  <label htmlFor="book-upload" className="cursor-pointer flex flex-col items-center justify-center gap-1">
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <button onClick={handleRemoveBookFile} className="text-sm text-red-600 hover:underline">
                    Remover arquivo
                  </button>
                </div>
              )}
            ...
            <div className="flex justify-end gap-4">
              <button onClick={handleSave} className="bg-black text-white px-6 py-2 rounded-md hover:bg-gray-800 transition">
                Salvar
              </button>
              <button onClick={handleCancel} className="border border-gray-400 text-black px-6 py-2 rounded-md hover:bg-gray-100 transition">
                Cancelar
              </button>
            </div>
          </div>
